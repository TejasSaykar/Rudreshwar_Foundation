    ...
    return (
        <> 
            <div className="flex flex-col items-center justify-center md:my-4"> 
                <div className="md:mt-10 bg-gray-50 px-4 pt-8 lg:mt-0 rounded-lg">
                    ...
                    <button className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Donate Now</button>
                </div>
            </div>
