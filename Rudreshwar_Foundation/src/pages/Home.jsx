...
const Home = () => {
    ...
    const data = [
        {id: 1, img: "/img/drug.jpg"},
        {id: 2, img: "/img/coun2.jpg"},
        {id: 3, img: "/img/coun3.jpg"}
    ]
    ...
    return (
        <div className=''>
            <div className="top relative h-[70vh] md:h-[90vh] w-full">
                <img src={data[currentImg].img} className='opacity-80 h-[60vh] md:h-[90vh] w-full' alt="drug" />
                ...
                <h2 className='absolute top-20 md:top-28 px-10 mt-14 text-xl font-bold text-orange-500 bg-gray-900 mx-6 py-4 rounded-md sm:text-5xl opacity-75'>MAKE SOMEONE'S LIFE HAPPY</h2>
            ...
            <div className=''>
                <div className='card py-4 w-full flex flex-col gap-3 px-2 sm:flex md:w-1/3 md:flex-row md:px-1 lg:px-2 lg:gap-4 items-center'>
                    <img src="/img/coun1.jpg" alt="" />
                    <img src="/img/coun2.jpg" alt="" />
                    <img src="/img/coun3.jpg" alt="" />
                </div>
            </div>
            <div className='px-3 py-4 bg-orange-50'>
                <h2 className='text-xl font-bold px-2 text-orange-500'>Services Offered</h2>
                <div className='list pl-5 my-2 flex flex-col gap-3'>
